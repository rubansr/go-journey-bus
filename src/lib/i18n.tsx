...
const dict: Dict = {
  ...
  gps_live_tracking: { en: "Live GPS tracking", ta: "நேரடி GPS கண்காணிப்பு" },
  gps_live: { en: "Live GPS", ta: "நேரடி GPS" },
  gps_waiting: { en: "Waiting for GPS", ta: "GPS-க்காக காத்திருக்கிறது" },
  gps_waiting_note: { en: "The driver has not started location sharing for this trip yet. Scheduled times are shown until GPS begins.", ta: "இந்தப் பயணத்திற்கு ஓட்டுநர் இட பங்கிடலை இன்னும் தொடங்கவில்லை. GPS தொடங்கும் வரை அட்டவணை நேரம் காட்டப்படும்." },
  bus_number: { en: "Bus", ta: "பேருந்து" },
  last_updated: { en: "last updated", ta: "கடைசி புதுப்பிப்பு" },
  current_speed: { en: "Current speed", ta: "தற்போதைய வேகம்" },
  direction: { en: "Direction", ta: "திசை" },
  distance_remaining: { en: "Distance remaining", ta: "மீதமுள்ள தூரம்" },
  route_replay: { en: "Route replay", ta: "பயண வழி மீள்பார்வை" },
  back_to_live: { en: "Back to live", ta: "நேரடிக்கு திரும்பு" },
  boarding_alert: { en: "Your bus is approaching", ta: "உங்கள் பேருந்து நெருங்குகிறது" },
